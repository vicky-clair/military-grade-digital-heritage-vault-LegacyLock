//! ============================================================================
//! LegacyLock 军规遗产密钥库 — Rust 密码学核心算法库 (Cryptographic Core Crate)
//! ============================================================================
//! 
//! 本 Crate 提供军规级双物理介质 (2-of-2 Hardware Separation) 的密钥生成、
//! Curve25519 椭圆曲线 Diffie-Hellman 会话协商、AES-256-GCM 认证加密与时效校验。
