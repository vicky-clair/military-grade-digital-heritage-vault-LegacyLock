//! ============================================================================
//! LegacyLock 军规遗产密钥库 — 原生命令行执行程序 (vault-cli)
//! ============================================================================
//! 
//! 命令体系：
//! 1. generate-keys: 生成双 U 盘密钥 (user-key.bin / heir-key.bin) 与继承配置 (config.bin)
//! 2. encrypt: 基于双钥匙派生密钥对明文资产库实施 AES-256-GCM 认证加密
//! 3. unlock: 双 U 盘在场联合激活与解密导出
//! 4. verify: 验证双钥匙合法性、公钥哈希及计划时效
